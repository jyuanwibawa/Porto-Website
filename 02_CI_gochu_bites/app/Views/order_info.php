...
<head>
  ...
  <style>
    ...
    .profile-container, .order-summary {
            padding: 20px;
            background-color: #f9f9f9;
            border-radius: 10px;
            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);
        }
        .profile-container .card-title, .order-summary .card-title {
            font-size: 1.5rem;
            font-weight: bold;
            margin-bottom: 20px;
            text-align: center;
...
<body>
  ...
  <div class="container mt-5">
        ...
        <div class="col-md-6 profile-container">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title">INFORMASI ALAMAT PENGIRIMAN</h2>
                    <form action="<?= site_url('/payment/process') ?>" method="post">
                        <div class="form-group">
                            <label for="full_name">Nama lengkap:</label>
                            <input type="text" class="form-control" id="full_name" name="full_name" placeholder="Masukkan nama anda" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="address" name="address" placeholder="Masukkan nama jalan, no rumah, kelurahan, kecamatan, kota" required>
                        </div>
                        <div class="form-group">
                            <label for="additional_details">Detail lainnya:</label>
                            <input type="text" class="form-control" id="additional_details" name="additional_details" placeholder="berikan informasi tambahan jika ada">
                        </div>
                        <div class="form-group">
