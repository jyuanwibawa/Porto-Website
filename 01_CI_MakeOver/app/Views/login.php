...
<body class=" antialiased font-normal leading-default bg-pink-1 text-black">
    <div class="flex justify-center items-center h-screen bg-gray-100">
        ...
        <div class="flex justify-center mb-4">
            ...
            <div class="mt-6">
                <button type="submit" class="w-full rounded-full bg-pink-2 hover:bg-pink-1 transition-colors text-white font-semibold px-4 py-2">Sign In</button>
            </div>
            <?php echo form_close() ?>
        </div>
    </div>
